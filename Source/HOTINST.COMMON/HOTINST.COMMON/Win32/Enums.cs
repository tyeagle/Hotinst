...
{	
	...
	{
		OCM__BASE				= (WindowMessage.WM_USER+0x1c00),
		OCM_COMMAND				= (OCM__BASE + WindowMessage.WM_COMMAND),
		OCM_CTLCOLORBTN			= (OCM__BASE + WindowMessage.WM_CTLCOLORBTN),
		OCM_CTLCOLOREDIT		= (OCM__BASE + WindowMessage.WM_CTLCOLOREDIT),
		OCM_CTLCOLORDLG			= (OCM__BASE + WindowMessage.WM_CTLCOLORDLG),
		OCM_CTLCOLORLISTBOX		= (OCM__BASE + WindowMessage.WM_CTLCOLORLISTBOX),
		OCM_CTLCOLORWinMsgBOX		= (OCM__BASE + WindowMessage.WM_CTLCOLORWinMsgBOX),
		OCM_CTLCOLORSCROLLBAR   = (OCM__BASE + WindowMessage.WM_CTLCOLORSCROLLBAR),
		OCM_CTLCOLORSTATIC		= (OCM__BASE + WindowMessage.WM_CTLCOLORSTATIC),
		OCM_CTLCOLOR			= (OCM__BASE + WindowMessage.WM_CTLCOLOR),
		OCM_DRAWITEM			= (OCM__BASE + WindowMessage.WM_DRAWITEM),
		OCM_MEASUREITEM			= (OCM__BASE + WindowMessage.WM_MEASUREITEM),
		OCM_DELETEITEM          = (OCM__BASE + WindowMessage.WM_DELETEITEM),
		OCM_VKEYTOITEM          = (OCM__BASE + WindowMessage.WM_VKEYTOITEM),
		OCM_CHARTOITEM          = (OCM__BASE + WindowMessage.WM_CHARTOITEM),
		OCM_COMPAREITEM         = (OCM__BASE + WindowMessage.WM_COMPAREITEM),
		OCM_HSCROLL             = (OCM__BASE + WindowMessage.WM_HSCROLL),
		OCM_VSCROLL             = (OCM__BASE + WindowMessage.WM_VSCROLL),
		OCM_PARENTNOTIFY        = (OCM__BASE + WindowMessage.WM_PARENTNOTIFY),
		OCM_NOTIFY              = (OCM__BASE + WindowMessage.WM_NOTIFY)
	}
	#endregion
