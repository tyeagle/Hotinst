...
namespace HOTINST.COMMON.Localization
{
    ...
    public static class LocalizationManager
    {
	    ...
	    private static readonly object _defaultResourceManagerSyncRoot = new object();
        ...
        /// </summary>
        private static readonly Dictionary<LocalizedProperty, LocalizedValue> _localizedValues = new Dictionary<LocalizedProperty, LocalizedValue>();
        ...
        internal static ResourceManager LoadResourceManager(string assemblyName, string baseName)
        {
            ...
            lock (_resourceManagers)
            {
                var result = _resourceManagers.Find(x => Equals(x.Assembly, assembly) && string.Equals(x.BaseName, baseName, StringComparison.CurrentCultureIgnoreCase));
