...
namespace HOTINST.COMMON.Localization
{
    ...
    public class LocalizeBindingExtension : MarkupExtension
    {
	    ...
	    /// <summary>
        /// Initializes a new instance of the <see cref="LocalizeBindingExtension"/> class.
        /// </summary>
        ...
        public LocalizeBindingExtension(string resourceKey)
        {
        ...
        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            if (service.TargetObject is DependencyObject)
            {
                ...
                {
	                var property = new LocalizedDependencyProperty((DependencyObject)service.TargetObject, (DependencyProperty)service.TargetProperty);
	                ...
	                var localizedValue = new BindingLocalizedValue(property, ResourceKey, StringFormat, _bindings);
