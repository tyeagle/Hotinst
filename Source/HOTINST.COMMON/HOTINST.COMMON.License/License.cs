...
namespace HOTINST.COMMON.License
{
    ...
    public class License
    {
		...
		public static string ComputerIdentify()
        {
            ...
            return info.GetComputerIdentify();
        }
		/// <summary>
		/// 注册
		/// </summary>
		...
		public static bool ValidateLicense(string licenseXml, string product, string version)
        {
            ...
            if (license.ComputerIdentify != computer.GetComputerIdentify())
            {
                return false;
            }

            return license.IsAuthenticated(computer.GetComputerIdentify(), product, version);
        }
