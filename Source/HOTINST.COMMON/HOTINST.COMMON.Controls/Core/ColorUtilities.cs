 ...
 * ==============================================================================
 *
 * ClassName: ColorUtilities
 * Description: 
 *
 * Version: 1.0
 * Created: 2017/3/30 10:43:55
...
namespace HOTINST.COMMON.Controls.Core
{
	...
	internal static class ColorUtilities
	{
		...
		public static Color ConvertHsvToRgb(double h, double s, double v)
		{
			...
			return Color.FromArgb(255, (byte)(System.Math.Round(r * 255)), (byte)(System.Math.Round(g * 255)), (byte)(System.Math.Round(b * 255)));
		}
