 ...
 * ==============================================================================
 *
 * ClassName: VisualStates
 * Description: 
 *
 * Version: 1.0
 * Created: 2018/8/27 15:41:47
...
namespace HOTINST.COMMON.Controls.Core
{
	internal static class VisualStates
	{
		...
		public static FrameworkElement GetImplementationRoot(DependencyObject dependencyObject)
		{
			...
			return VisualTreeHelper.GetChildrenCount(dependencyObject) == 1 ? VisualTreeHelper.GetChild(dependencyObject, 0) as FrameworkElement : null;
		}
