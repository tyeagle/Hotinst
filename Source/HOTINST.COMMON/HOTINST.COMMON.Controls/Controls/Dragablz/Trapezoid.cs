...
namespace HOTINST.COMMON.Controls.Controls.Dragablz
{
    public class Trapezoid : ContentControl
    {
        ...
        private static PathGeometry CreateGeometry(Size contentDesiredSize)
        {
            ...
            const int angle = 20;
            const double radians = angle * (System.Math.PI / 180);
            ...
            var triangleX = System.Math.Tan(radians) * (contentDesiredSize.Height);
            ...
            triangleX = System.Math.Tan(radians) * (contentDesiredSize.Height);
