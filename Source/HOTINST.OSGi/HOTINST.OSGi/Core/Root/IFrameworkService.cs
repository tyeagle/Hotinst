...
namespace HOTINST.OSGI.Core.Root
{
    ...
    interface IFrameworkService
    {
        ...
        /// 注册一个公开的服务对象
        /// </summary>
        /// <param name="bundleContext">提供服务的Bundle的上下文</param>
        /// <param name="contracts">服务约束，服务接口名称</param>
        /// <param name="service">提供服务的对象</param>
        /// <param name="properties">服务属性，用于识别相同接口的不同服务对象</param>
